import '../../App.css'
import './subject.css'
import { displayDate, type Props } from "../../helpers/helpers";

export const SubjectSection = ({selectedValue, index}: Props) => {
    return(
        <section className="section-container my-5 p-4" id  = 'subject'>
                <h3 className="text-center section-heading p-2" id = 'subject-heading'><strong>📚 {selectedValue[0].name} - {displayDate({selectedValue, index})}</strong></h3>
